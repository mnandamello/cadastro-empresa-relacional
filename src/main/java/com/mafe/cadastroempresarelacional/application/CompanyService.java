...
public class CompanyService {
    ...
    public ApiResponse createCompany(CreateCompanyRequest request){
        ...
        if (request.getCompanySituation() != CompanySituation.ACTIVE && request.getCompanySituation() != CompanySituation.INACTIVE ){
        ...
        newCompany.setCompanySituation(request.getCompanySituation());
